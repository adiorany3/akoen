...
files = ["ambil.yaml", "ambil2.yaml", "ambil3.yaml", "ambil4.yaml", "ambil5.yaml", "ambil6.yaml", "ambil7.yaml", "ambil8.yaml", "ambil9.yaml", "ambil10.yaml", "ambil11.yaml", "ambil12.yaml", "ambil13.yaml", "ambil14.yaml", "ambil15.yaml", "ambil16.yaml", "ambil17.yaml", "ambil18.yaml", "ambil19.yaml", "ambil20.yaml", "ambil21.yaml", "ambil22.yaml"]
